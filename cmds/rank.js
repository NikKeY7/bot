...
module.exports.run = async (bot,message,args) => {
   ...
   /* bot.uploadFile({
    ...
    let attack = profile[message.member.id].damage;
    let mattack = profile[message.member.id].damage*3;

    let nick_to = nick.replace(/ /g,  '-9');

    let url = "https://mini.s-shot.ru/950x150/PNG/2000/Z100/?l988114o.beget.tech%2Fcard.php?hp="+ hp +"&maxHp="+ maxHp +"&mana="+ mana +"&lvl="+ lvl +"%26xp="+ xp +"&maxXp="+ maxXp +"&attack="+attack+"&mattack="+mattack+"&armo=1&nick="+ nick_to +"&ava="+ava;
